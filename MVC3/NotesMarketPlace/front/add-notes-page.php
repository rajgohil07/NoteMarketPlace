...
if (isset($_SESSION['email'])) {
    ...
    if (isset($_POST['publish'])) {
        ...
        try {
            ...
            $mail->IsHTML(true);
            $mail->Subject = $full_name . " sent his note for review";

            $mail->Body = "Hello Admins,<br>
            We want to inform you that,<b>$full_name</b> sent his note
            <b>$title</b> for review. Please look at the notes and take required actions.<br>
            Regards,<br>
