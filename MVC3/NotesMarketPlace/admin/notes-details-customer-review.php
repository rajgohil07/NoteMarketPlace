...
<body>
    ...
    <div id="notes-details-reviews">
        ...
        if (mysqli_num_rows($review_decide) > 0) {
            ...
            $rate_counter = 1;
            $review_getter = mysqli_query($con, "SELECT sellernotesreview.note_review_id,users.userid,users.firstname,users.lastname,sellernotesreview.ratings,sellernotesreview.comments,userprofile.profile_pic 
                                                 FROM users 
            ...
            while ($row = mysqli_fetch_assoc($review_getter)) {
                $rate_counter++;
                $note_review_id = $row['note_review_id'];
        ...
        <div class="row notes-review-ender-line">
            ...
            <div class="col-md-10 col-9">
                <div class="row">
                    ...
                    <div class="col-md-1 text-right">
                        ...
                        <!-- del review link -->
                        <a href="notes-details-customer-review-delete.php?id=<?php echo $note_review_id ?>&noteid=<?php echo $noteid ?>"
                            title="Delete Review of <?php echo $full_name ?>">
                            <img src="images/delete.png" class="del-user-review notes-details-review-upper-img"
                                alt="Delete">
                        </a>
            ...
            <div class="col-md-10 notes-details-review-upper">
                <div class="notes-details-name-rating-review">
