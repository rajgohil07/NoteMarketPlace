        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 column-padding-remover ">
                    <h4 class="blue-font-30 heading-margin margin-l">Manage Type</h4>
                </div>
                <div class="col-md-6 column-padding-remover">
                    <button type="submit" class="btn btn-primary blue-button-hover-white margin-l margin-top-15">add
                        Type</button>
                </div>
