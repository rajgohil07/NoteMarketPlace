                    ...
                    <table id="myTable" class="table entire-table table-small">
                        ...
                        <tbody>
                            ...
                            while ($row = mysqli_fetch_assoc($rejected_note_result)) {
                                ...
                                $title = $row['title'];
                                $category = $row['name'];
                                $remark_admin = $row['admin_remarks'];
                                (empty($remark_admin) || $remark_admin = "") ? $remark_admin = "Lorem Ipsum Dolor Sit Amet Consectetur" : "";
                            ?>
                            <tr>
                                ...
                                <td><a href="notes-details-page.php?id=<?php echo $noteid; ?>"
                                        title="click to view <?php echo $title ?>" class="deco-none"
                                        title="click here to clone <?php echo $title ?>">clone</a></td>
                                <td>
