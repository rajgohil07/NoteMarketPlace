...
if (isset($_GET['noteid'])) {
    ...
    $allow_download_enable = mysqli_query($con, "UPDATE downloads SET sellerhasalloweddownload=1 WHERE noteid=$noteid_allow AND downloader=$downloader_allow");
    ...
    try {
        ...
        $mail->setFrom($email, $full_name_seller);
        $mail->addAddress($email_buyer, $full_name_buyer);
        $mail->addReplyTo($email, $full_name_seller);
        $mail->IsHTML(true);
        $mail->Subject = $full_name_seller . " Allows you to download a note";

        $mail->Body = "Hello <b>$full_name_buyer</b>,<br>
        We would like to inform you that,<b>$full_name_seller</b> Allows you to download a note.
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 column-padding-remover">
                    <table id="myTable" class="table entire-table table-medium">
                        <thead>
