                            ...
                            <div class="row">
                                <div class="col-lg-2 col-md-4 col-sm-4 col-6 search-type-gap">
                                    <select id="search_type" onchange="showNotes()"
                                        ...
                                        <?php
                                        $result = mysqli_query($con, "SELECT typeid,name FROM notetypes");
                                ...
                                <div class="col-lg-2 col-md-4 col-sm-4 col-6 search-type-gap">
                                    <select id="search_category" onchange="showNotes()"
                                        ...
                                        <?php
                                        $result = mysqli_query($con, "SELECT categoryid,name FROM notecategories");
                                        while ($row = mysqli_fetch_assoc($result)) {
                                ...
                                <div class="col-lg-2 col-md-4 col-sm-4 col-6 search-type-gap">
                                    <select id="search_university" onchange="showNotes()"
                                        ...
                                        <?php
                                        $result = mysqli_query($con, "SELECT DISTINCT university_name FROM sellernotes");
                                        while ($row = mysqli_fetch_assoc($result)) {
                                ...
                                <div class="col-lg-2 col-md-4 col-sm-4 col-6 search-type-gap">
                                    <select id="search_course" onchange="showNotes()"
                                        ...
                                        <?php
                                        $result = mysqli_query($con, "SELECT DISTINCT course FROM sellernotes");
                                        while ($row = mysqli_fetch_assoc($result)) {
                                            $course = $row['course'];
                                ...
                                <div class="col-lg-2 col-md-4 col-sm-4 col-6 search-type-gap">
                                    <select id="search_country" onchange="showNotes()"
                                        ...
                                        <?php
                                        $result = mysqli_query($con, "SELECT countryid,name FROM countries");
                                        while ($row = mysqli_fetch_assoc($result)) {
