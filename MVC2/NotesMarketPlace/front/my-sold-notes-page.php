        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 column-padding-remover">
                    <table id="myTable" class="table entire-table table-small column-padding-remover">
                        <thead>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><a class="deco-none" title="click to view <?php echo $title ?>"
                                ...
                                <td><?php echo date("d M Y,G:i:s", strtotime($time)) ?></td>
                                <td>
                                    <div class="table-pic-combiner">
                                        <a href="notes-details-page.php?id=<?php echo $noteid; ?>"> <img
                                                src="images/eye.png" class="table-first-img"
                                                title="Click to view <?php echo $title ?>" alt="View"></a>
                                        <div class="dropdown dropleft">
                                            ...
                                            <ul class="dropdown-menu shadow-drop dropdowncustom-width dropdowncustom">
                                                <li><a
                                                        href="my-sold-notes-page.php?noteid=<?php echo $noteid; ?>&downloader=<?php echo $downloader; ?>">
