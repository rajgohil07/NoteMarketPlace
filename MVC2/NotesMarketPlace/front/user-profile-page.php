                            ...
                            <div class="form-group col-md-6">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col">
                                        ...
                                        echo ($exist != 0) ? "  <input type='tel' value='$number' name='phone_no' class='form-control right-content' placeholder='Enter your phone number'>" : "  <input type='tel' name='phone_no' class='form-control right-content' placeholder='Enter your phone number' required>";
                                        ?>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-md-12">
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                echo ($exist != 0) ? "<input name='add_line1' value='$add1' type='text' class='form-control input-light-color'
                            ...
                            <div class="form-group col-md-6">
                                ...
                                echo ($exist != 0) ? "<input name='add_line2' value='$add2' type='text' class='form-control input-light-color right-content'
                    ...
                    <div class="col-md-12">
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                echo ($exist != 0) ? "<input type='text' name='city' value='$city_temp' class='form-control input-light-color'
                            ...
                            <div class="form-group col-md-6">
                                ...
                                echo ($exist != 0) ? "<input name='state' value='$state' type='text' class='form-control input-light-color right-content'
                    ...
                    <div class="col-md-12">
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                echo ($exist != 0) ? "<input name='zip_code' value='$zipcode' type='number' class='form-control input-light-color'
