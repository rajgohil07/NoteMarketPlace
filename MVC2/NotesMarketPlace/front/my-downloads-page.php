...
if (isset($_POST['inappropriate_submit'])) {
    ...
    if ($count_inappropriate == 0) {
        ...
        try {
            ...
            $mail->setFrom($email_buyer, $full_name_reporter);
            $mail->addAddress($reporter_againts_email, "NotesMarketPlace");
            $mail->addReplyTo($email_buyer, $full_name_reporter);
            $mail->IsHTML(true);
                    ...
                    <table id="myTable" class="table entire-table table-small">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><a class="deco-none" title="click to view <?php echo $notetitle ?>"
                                        href="notes-details-page.php?id=<?php echo $noteid ?>"><?php echo $notetitle ?></a>
                                </td>
                                ...
                                <td><?php echo date("d M Y,G:i:s", strtotime($createddate)); ?></td>
                                <td>
                                    <div class="table-pic-combiner">
                                        <a href="notes-details-page.php?id=<?php echo $noteid ?>"> <img
                                                src="images/eye.png" title="Click to view <?php echo $notetitle ?>"
                                                class="table-first-img" alt="View"></a>
                                        <div class="dropdown dropleft">
                                            ...
                                            <ul class="dropdown-menu shadow-drop dropdowncustom-width dropdowncustom">
                                                ...
                                                <li><a role="button" data-id="<?php echo $noteid; ?>"
