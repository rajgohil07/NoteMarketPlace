...
if (isset($_POST['purchase_yes_box'])) {
    ...
    if ($download_entry_number == 0 && $buyerid != $sellerid) {
        ...
        try {
            ...
            $mail->setFrom($email, $full_name_buyer);
            $mail->addAddress($email_seller, $full_name_seller);
            $mail->addReplyTo($email, $full_name_buyer);
            $mail->IsHTML(true);
            $mail->Subject = $full_name_buyer . " wants to purchase your notes";

            $mail->Body = "Hello <br>$full_name_seller</b>,<br>
            We would like to inform you that,<b>$full_name_buyer</b> wants to purchase your notes. Please see
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <p class="dark-font-14">Please Contact us on +919875489876.</p>
