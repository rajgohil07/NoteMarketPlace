        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 column-padding-remover">
                    <h4 class="blue-font-30 heading-margin margin-l">Manage Category</h4>
                </div>
                <div class="col-md-6 column-padding-remover">
                    <button type="submit" class="btn btn-primary margin-l blue-button-hover-white margin-top-15">add
                        category</button>
                </div>
            ...
            <div class="row">
                <div class="col-md-12 column-padding-remover margin-top-15">
                    <div class="table-responsive">
                        <table class="table entire-table table-small text-center">
